...
description: Motion and interaction design for web and app UI. Use when building interactive components with purposeful animation, or reviewing/auditing existing motion design. Covers HTML/CSS, React, Framer Motion/Motion, iOS/Android transitions, and design system animations. Two modes: Create (build or improve motion) and Audit (review existing animations and report findings).
---
